...
%FIGURE 6
\begin{tikzpicture}[node distance=0.81cm]

\fontsize{13pt}{0pt}\selectfont
\node(pro1)[process4]{Signal frame = s};
\node(arrow1)[khongvien, below of=pro1]{\includegraphics[scale=0.6]{arrow1.png}};
\node(pro2)[process4,below of=arrow1]{S = DFT(s)};
\node(arrow2)[khongvien, below of=pro2]{\includegraphics[scale=0.6]{arrow1.png}};
\node(pro3)[process4,below of=arrow2]{$|\text{S}|$};
\node(arrow3)[khongvien, below of=pro3]{\includegraphics[scale=0.6]{arrow1.png}};
\node(pro4)[process4,below of=arrow3]{L = $\text{log}_2(|\text{S}|)$};
\node(arrow4)[khongvien, below of=pro4]{\includegraphics[scale=0.6]{arrow1.png}};
\normalsize
\node(pro5)[process4,below of=arrow4]{C = real ( DFT ( L ))};
